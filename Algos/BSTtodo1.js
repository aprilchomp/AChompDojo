...
// BST: Max: // Create a max() BST method that returns the largest value contained in the binary search tree.


// BST: Size: // Write a size() method that returns the number of nodes (values) contained in the tree.


// BST: Is Empty: // Create an isEmpty() method to return whether the BST is empty (whether it contains no values).
